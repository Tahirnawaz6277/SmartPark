...
{
    public class UpdateLocationHandler : IRequestHandler<UpdateLocationCommand, CreateLocationReponse>
    {
        private readonly ILocationService _service;
        public UpdateLocationHandler(ILocationService service) => _service = service;

        public async Task<CreateLocationReponse> Handle(UpdateLocationCommand request, CancellationToken cancellationToken)
